...
import PaginationParamsDto from '../dto/update-article-pagination.dto';
...
export default class ArticleController {
  ...
  @Get()
  async getPosts(@Query() query: PaginationParamsDto) {
    const { limit, offset, startId, search } = query;
